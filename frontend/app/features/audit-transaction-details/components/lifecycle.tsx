        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex items-start gap-4 pb-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium">First Detected</h3>
                  <TimeDisplay
            ...
            <div className="relative flex items-start gap-4 pb-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium">Submitted to Mempool</h3>
                  <TimeDisplay
                    timestamp={transaction.first_seen_at}
                    className="text-xs text-muted-foreground"
                    enableToggle
            ...
            {transaction.block_number && (
              <div className="relative flex items-start gap-4 pb-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <h3 className="text-sm font-medium">Included in Block</h3>
                    <TimeDisplay
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium">Last Observed</h3>
                  <TimeDisplay
                    timestamp={transaction.last_observed_at}
                    className="text-xs text-muted-foreground"
                    enableToggle
