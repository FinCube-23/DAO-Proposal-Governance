...
export default function InfoGridItem({
  ...
  return (
    <div className="p-3 sm:p-4 bg-slate-800/50 rounded-lg hover:bg-slate-800/30 transition-colors group">
      ...
      <div className="text-white text-sm sm:text-base font-semibold mb-1 break-words">
        {value}
      </div>
