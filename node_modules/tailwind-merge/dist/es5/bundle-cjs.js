...
var getDefaultConfig = function getDefaultConfig() {
  ...
  var scaleInset = function scaleInset() {
    return [isFraction, 'px', 'full', 'auto', isArbitraryVariable, isArbitraryValue, themeSpacing];
  };
  ...
  var scaleGap = function scaleGap() {
  ...
  var scalePadding = function scalePadding() {
    return ['px'].concat(scaleUnambiguousSpacing());
  };
  var scaleMargin = function scaleMargin() {
    return ['px', 'auto'].concat(scaleUnambiguousSpacing());
  };
  var scaleSizing = function scaleSizing() {
    return [isFraction, 'auto', 'px', 'full', 'dvw', 'dvh', 'lvw', 'lvh', 'svw', 'svh', 'min', 'max', 'fit', isArbitraryVariable, isArbitraryValue, themeSpacing];
  };
  ...
  var scaleTranslate = function scaleTranslate() {
    return [isFraction, 'full', 'px', isArbitraryVariable, isArbitraryValue, themeSpacing];
  };
  return {
    cacheSize: 500,
    theme: {
    ...
    classGroups: {
       ...
       */
      indent: [{
        indent: ['px'].concat(scaleUnambiguousSpacing())
      }],
      /**
       * Vertical Alignment
