    ...
    def validate_user_id(self, value):
        try:
            ...
            if not user.is_active:
                raise serializers.ValidationError("User is inactive and cannot be added to an organization")
    ...
    def validate_organization_id(self, value):
        try:
            ...
            if not organization.is_active:
                raise serializers.ValidationError("Organization is inactive and cannot accept new members")
