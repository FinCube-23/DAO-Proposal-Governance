...
export class ProposalEntity {
  ...
  @ApiProperty({
    description:
      "A proposal can be cancelled or get executed by some DAO member. This field will store the action taker's wallet address.",
  ...
  //   @ApiProperty({
  //     description:
  //       'This is the primary key from AUDIT TRAIL SERVICE. This field will be assigned through inter-service communication.',
  //     required: false,
  //   })
  //   audit_id: number;
